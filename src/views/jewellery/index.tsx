...
const Jewellery = () => {
  return (
    <div className='px-1 mt-28 text-grey-700'>
        {/* Top */}
    ...
    <div className='flex flex-col md:flex-row justify-between py-4 mt-2 gap-5'>
        ...
        <div className='relative basis-1/2 gap-10 grid grid-cols-2 grid-rows-2'>
            <div className='absolute -z-50 text-slate-200 inset-0'>
                <h6 className='text-5xl md:text-7xl lg:text-[7.5rcm] leading-[5.9rcm] font-bold'>
                    Different from others
                </h6>
            </div>
            <div className='max-w [13rem] space-y-2 '>
                <h6 className='font-semibold text-xl'>Using Good Quality Materials
</h6>
...
<p className='text-lg leading-5'>Lorem ipsum dolor sit amt, consectetur adipiscing elit.</p>
       ...
       <div className='  p-6'>
        <p style={{wordSpacing:"0.8rem"}} className="h-[90%] lg:max-w-[15rem]">This piece is ethically crafted in our small family-owned workshop in Peru 
            with unmatched attention to detail and care. The Natural color is the actual
             natural color of the fiber, undyed and 100% traceable.</p>
