...
const ProductsType = () => {
  return (
    <div className="py-16 mt-28 px-10 space-y-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 text-gray-800 mx-auto">
        ...
        {/* first grid */}
        <div className="w-full flex flex-col items-center bg-gray-300 justify-between sm:flex-row col-span-1 md:col-span-2 bg-cat1 px-12" >
        ...
        {/* third grid */}
        <div className="w-full row-span-1 bg-slate-300 md:row-span-2 flex flex-col items-center h-full bg-cat4">
          {/* text */}
          <div className="p-4">
            <p>Flex Sweatshirt</p>
            <p className="text-lg">
        ...
        {/* fourth grid */}
        <div className="py-9 text-white bg-black w-full col-auto md:col-span-2 bg-cat2 flex flex-col justify-center items-center space-y-3">
